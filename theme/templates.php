...
<head>
<meta charset="utf-8">
<title>Wongibe / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. 670976367</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">GradConnect<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='VOID47'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=Contact">VOID47</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Zoatupsi, Messasi<br>
           Pin-21542 Camerron.</address>
          <p>
            <i class="icon-phone"></i> 670976367 <br>
            <i class="icon-envelope-alt"></i> wongibesahmoah@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
